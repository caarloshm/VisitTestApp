...
export class IdentificacionComponent implements OnInit {
  ...
  constructor(
    @Inject(MAT_DIALOG_DATA) public identification :any,
    public dialogRef: MatDialogRef<IdentificacionComponent>,
    
  ) { }

  matcher = new MyErrorStateMatcher();
  type: string | undefined;
  formIdentification = new FormGroup({
    nameId : new FormControl('', [Validators.required])
  })

  show:boolean = false;

  get formGroup() { return this.formIdentification.controls; }

  ngOnInit(): void {
    this.type = this.identification.type;
    if (this.type === 'edit') {
  ...
  createTerminal(): void {
    ...
    if(this.formIdentification.invalid) return;

    console.log(this.formGroup.nameId.value);
